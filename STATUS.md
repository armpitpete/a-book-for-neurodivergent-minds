...
The 35-chapter main book sequence has been conceptually checked.
...
Local inventory confirmed the active module folder contains only the current 12 tools:

- `01_The_One_Pressure_Check.md`
- `02_The_Good_Enough_Line.md`
- `03_The_Next_Safe_Step.md`
- `04_The_Capacity_Check.md`
- `05_The_Body_Floor_Check.md`
- `06_The_Choice_Shrinker.md`
- `07_The_Support_Ask.md`
- `08_Noise_Budget.md`
- `09_The_Transition_Bridge.md`
- `10_The_Boundary_Exit_Card.md`
- `11_The_Misread_Map.md`
- `12_The_Quiet_Handover.md`

Legacy module files are preserved in:
