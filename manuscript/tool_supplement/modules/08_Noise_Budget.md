...
Name the loudest load right now.
...
Put one word beside any line that is active.
...
Make a simple budget for the rest of the day.

Ask:

1. What load can I remove?
2. What load can I delay?
3. What load can I make easier?
4. What body need is making everything harder?

Example:

- remove: no supermarket today
- delay: reply tomorrow
